...
class Interanio_breadcrumb {
	...
	private function __construct() {
		...
		add_filter('interanio_page_title', [$this, 'hide_title']);
	...
	public function breadcrumb_register() {
		$labels = [
			'name'               => esc_html__('Breadcrumbs', 'interanio'),
			'singular_name'      => esc_html__('Breadcrumb', 'interanio'),
			'menu_name'          => esc_html__('Breadcrumbs', 'interanio'),
			'name_admin_bar'     => esc_html__('Breadcrumb', 'interanio'),
			'add_new'            => esc_html__('Add New', 'interanio'),
			'add_new_item'       => esc_html__('Add New Breadcrumb', 'interanio'),
			'new_item'           => esc_html__('New Header Footer & Blocks Template', 'interanio'),
			'edit_item'          => esc_html__('Edit Header Footer & Blocks Template', 'interanio'),
			'view_item'          => esc_html__('View Header Footer & Blocks Template', 'interanio'),
			'all_items'          => esc_html__('All Breadcrumb', 'interanio'),
			'search_items'       => esc_html__('Search Header Footer & Blocks Templates', 'interanio'),
			'parent_item_colon'  => esc_html__('Parent Header Footer & Blocks Templates:', 'interanio'),
			'not_found'          => esc_html__('No Header Footer & Blocks Templates found.', 'interanio'),
			'not_found_in_trash' => esc_html__('No Header Footer & Blocks Templates found in Trash.', 'interanio'),
		];
		...
		register_post_type('interanio-breadcrumb', $args);
	}
	...
	public function register_admin_menu() {
		add_submenu_page(
			'themes.php',
			esc_html__('Breadcrumbs', 'interanio'),
			esc_html__('Breadcrumbs', 'interanio'),
			'edit_pages',
			'edit.php?post_type=interanio-breadcrumb'
		);
	}
	...
	function ehf_register_metabox() {
		add_meta_box(
			'ehf-meta-box',
			esc_html__('Breadcrumb Options', 'interanio'),
			[
				$this,
				'efh_metabox_render',
			],
			'interanio-breadcrumb',
			'normal',
			'high'
		);
	}
		...
		<table class="hfe-options-table widefat">
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('Display On', 'interanio'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
					   title="<?php echo esc_attr__('Add locations for where this template should appear.', 'interanio'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					...
					HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
						...
						[
							'title'          => esc_html__('Display Rules', 'interanio'),
							'value'          => '[{"type":"basic-global","specific":null}]',
							'tags'           => 'site,enable,target,pages',
							'rule_type'      => 'display',
							'add_rule_label' => esc_html__('Add Display Rule', 'interanio'),
						],
						$include_locations
					);
					?>
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('Do Not Display On', 'interanio'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
					   title="<?php echo esc_attr__('Add locations for where this template should not appear.', 'interanio'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					<?php
					HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
						...
						[
							'title'          => esc_html__('Exclude On', 'interanio'),
							'value'          => '[]',
							'tags'           => 'site,enable,target,pages',
							'add_rule_label' => esc_html__('Add Exclusion Rule', 'interanio'),
							'rule_type'      => 'exclude',
						],
						$exclude_locations
					);
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('User Roles', 'interanio'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help" title="<?php echo esc_attr__('Display custom template based on user role.', 'interanio'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					<?php
					HFE\Lib\Astra_Target_Rules_Fields::target_user_role_settings_field(
						...
						[
							'title'          => esc_html__('Users', 'interanio'),
							'value'          => '[]',
							'tags'           => 'site,enable,target,pages',
							'add_rule_label' => esc_html__('Add User Rule', 'interanio'),
						],
						$users
					);
					?>
	...
	public static function get_template_id() {
		...
		$hfe_templates = Astra_Target_Rules_Fields::get_instance()->get_posts_by_conditions('interanio-breadcrumb', $option);
	...
	public function block_template_frontend() {
		if (is_singular('interanio-breadcrumb') && !current_user_can('edit_posts')) {
	...
	function load_canvas_template($single_template) {
		...
		if ('interanio-breadcrumb' == $post->post_type) {
