(function ($) {
    ...
    function product_swatches_attr_image() {
        $('body').on('click', '.product-block .anila-product-swatches, .product-list .anila-product-swatches', function () {
            console.log('tesst')
            var image = $(this).data('image');
    ...
    function quick_product_variable() {
        ...
        $(document).on('click', btnSelector, function (e) {
            ...
            if ($product.hasClass('quick-shop-loaded')) {
                ...
                $('body').trigger('anila-quick-view-displayed');
                return;
            }
            ...
            $.ajax({
                url: anilaAjax.ajaxurl, data: {
                    action: 'anila_quick_shop', id: id,
            ...
            // Ajax action.
            xhr = $.ajax({
                url: wc_add_to_cart_params.wc_ajax_url.toString().replace('%%endpoint%%', 'anila_add_to_cart'),
                data: formData,
                type: 'POST',
                processData: false,
                contentType: false,
