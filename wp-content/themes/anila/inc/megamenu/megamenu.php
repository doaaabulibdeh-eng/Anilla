...
class Anila_Megamenu {
    ...
    public function __construct() {
        ...
        add_filter('anila_nav_menu_args', [$this, 'set_menu_args'], 99999);

    }

    public function set_menu_args($args) {
        $args['walker'] = new Anila_Megamenu_Walker();
    ...
    private function check_megamenu() {
        ...
        foreach ($all as $menu_item) {
            $elementor_id = anila_megamenu_get_post_related_menu($menu_item->ID);
            if ($elementor_id) {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script('anila-megamenu-frontend', get_template_directory_uri() . '/inc/megamenu/assets/js/frontend.js', array('jquery'), $anila_version, true);
