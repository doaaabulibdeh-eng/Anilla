...
class Anila_WP_Widget_Recent_Posts extends WP_Widget_Recent_Posts {
	public function widget( $args, $instance ) {
		if ( ! isset( $args['widget_id'] ) ) {
			$args['widget_id'] = $this->id;
		}

		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Recent Posts', 'anila' );
		...
		<ul>
			<?php foreach ( $r->posts as $recent_post ) : ?>
				...
				$title        = ( ! empty( $post_title ) ) ? $post_title : esc_html__( '(no title)', 'anila' );
				?>
				<li>
					...
					<div class="recent-posts-info">
                        <div class="recent-posts-top-info entry-meta-top">
                            <?php anila_post_meta(['show_date' => true, 'show_author' => false, 'show_cat' => false,  'show_comment' => false]); ?>
                        </div>
