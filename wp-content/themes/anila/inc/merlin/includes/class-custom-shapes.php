...
/**
 * Class Anila_Elementor_Custom_Shapes
 *
 * Main Plugin class
 * @since 0.0.1
 */
class Anila_Elementor_Custom_Shapes {
    ...
    public function ecs_register_cpt() {
        ...
        $labels = array(
            'name'                  => _x('Custom shapes', 'Post Type General Name', 'anila'),
            'singular_name'         => _x('Custom shape', 'Post Type Singular Name', 'anila'),
            'menu_name'             => __('Custom shapes', 'anila'),
            'name_admin_bar'        => __('Custom shape', 'anila'),
            'archives'              => __('Item Archives', 'anila'),
            'attributes'            => __('Item Attributes', 'anila'),
            'parent_item_colon'     => __('Parent Item:', 'anila'),
            'all_items'             => __('All Items', 'anila'),
            'add_new_item'          => __('Add New Item', 'anila'),
            'add_new'               => __('Add New', 'anila'),
            'new_item'              => __('New Item', 'anila'),
            'edit_item'             => __('Edit Item', 'anila'),
            'update_item'           => __('Update Item', 'anila'),
            'view_item'             => __('View Item', 'anila'),
            'view_items'            => __('View Items', 'anila'),
            'search_items'          => __('Search Item', 'anila'),
            'not_found'             => __('Not found', 'anila'),
            'not_found_in_trash'    => __('Not found in Trash', 'anila'),
            'featured_image'        => __('Featured Image', 'anila'),
            'set_featured_image'    => __('Set featured image', 'anila'),
            'remove_featured_image' => __('Remove featured image', 'anila'),
            'use_featured_image'    => __('Use as featured image', 'anila'),
            'insert_into_item'      => __('Insert into item', 'anila'),
            'uploaded_to_this_item' => __('Uploaded to this item', 'anila'),
            'items_list'            => __('Items list', 'anila'),
            'items_list_navigation' => __('Items list navigation', 'anila'),
            'filter_items_list'     => __('Filter items list', 'anila'),
        );
        $args   = array(
            'label'               => __('Custom shape', 'anila'),
            'description'         => __('Custom shapes', 'anila'),
            'labels'              => $labels,
    ...
    public function ecs_register_admin_menu() {
        $menu_title = _x('Custom Shapes', 'Elementor Custom Shapes', 'anila');
        add_submenu_page(
            'elementor',
            $menu_title,
            $menu_title,
...
Anila_Elementor_Custom_Shapes::instance();