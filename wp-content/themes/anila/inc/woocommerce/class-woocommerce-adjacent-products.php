<?php
/**
 * Anila WooCommerce Adjacent Products Class
 *
 * @package  aro
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Anila_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Anila WooCommerce Adjacent Products Class
	 */
	class Anila_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'anila_woocommerce_adjacent_query_args', $args ) );
