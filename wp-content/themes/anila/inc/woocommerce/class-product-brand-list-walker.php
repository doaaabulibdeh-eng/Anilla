<?php
/**
 * Anila_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Anila_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Anila_Product_Brand_List_Walker', false)) :

	class Anila_Product_Brand_List_Walker extends Walker {
