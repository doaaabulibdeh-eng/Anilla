...
class Anila_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Team Box', 'anila');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'teams',
            [
                'label' => esc_html__('Team Item', 'anila'),
        ...
        $this->add_control(
            'facebook',
            [
                'label'       => esc_html__('Facebook', 'anila'),
                'placeholder' => esc_html__('https://www.facebook.com/themelexus', 'anila'),
        ...
        $this->add_control(
            'twitter',
            [
                'label'       => esc_html__('Twitter', 'anila'),
                'placeholder' => esc_html__('https://twitter.com/themelexus', 'anila'),
        ...
        $this->add_control(
            'pinterest',
            [
                'label'       => esc_html__('Pinterest', 'anila'),
                'placeholder' => esc_html__('https://www.pinterest.com/', 'anila'),
        ...
        $this->add_control(
            'youtube',
            [
                'label'       => esc_html__('Youtube', 'anila'),
                'placeholder' => esc_html__('https://www.youtube.com/', 'anila'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Social', 'anila'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
                    ...
                    <?php if (!empty($settings[$key])) : ?>
                        <li class="social">
                            <a href="<?php echo esc_url($settings[$key]) ?>">
                                <i class="anila-icon-<?php echo esc_attr($social); ?>"></i>
                            </a>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>
...
$widgets_manager->register(new Anila_Elementor_Team_Box());
