...
class Anila_Elementor_Nav_Menu extends Elementor\Widget_Base {

    protected $nav_menu_index = 1;

    public function get_name() {
        return 'anila-nav-menu';
    }

    public function get_title() {
        return esc_html__('Anila Nav Menu', 'anila');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography Menu', 'anila'),
        ...
        $this->add_group_control(
            Anila_Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Typography Sub Menu', 'anila'),
        ...
        $this->add_control(
            ...
            [
                ...
                'prefix_class' => 'anila-nav-menu-divider-',
            ]
        );
        ...
        $this->add_control(
            'menu_title_color',
            [
                'label'     => esc_html__('Color Menu', 'anila'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Sub Menu', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'sub_menu_color',
            [
                'label'     => esc_html__('Background Dropdown', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}}.anila-nav-menu-divider-yes .main-navigation ul.menu > li.menu-item > a:before' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Item', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
         ...
         $this->add_control(
            'line_color_hover',
            [
                'label'     => esc_html__('Line Color', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render() {
        ...
        <div <?php $this->print_render_attribute_string('wrapper'); ?>>
            <nav class="main-navigation" role="navigation" aria-label="<?php esc_attr_e('Primary Navigation', 'anila'); ?>">
                <?php wp_nav_menu(apply_filters('anila_nav_menu_args', [
                    'menu'            => $settings['menu'],
...
$widgets_manager->register(new Anila_Elementor_Nav_Menu());
