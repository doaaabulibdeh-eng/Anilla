...
class Anila_Call_To_Action extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Anila Banner', 'anila');
    }
    ...
    protected function register_controls( $args = [] ) {
        ...
        $this->add_control(
            'bg_image',
            [
                'label'   => esc_html__('Choose Background Image', 'anila'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__('Image Resolution', 'anila'),
                'default'   => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('This is the sub title', 'anila'),
                'placeholder' => esc_html__('Enter your sub title', 'anila'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            'sub_title_position',
            [
                'label'        => __('Position Sub Title', 'anila'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'below',
                'options'      => [
                    'above' => __('Above', 'anila'),
                    'below' => __('Below', 'anila'),
                ],
        ...
        $this->add_control(
            'title',
            [
                'label'       => esc_html__('Heading 1', 'anila'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [
                    'active' => true,
                ],
                'default'     => esc_html__('This is the heading 1', 'anila'),
                'placeholder' => esc_html__('Enter your heading 1', 'anila'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            'heading2',
            [
                'label'       => esc_html__('Heading 2', 'anila'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [
                    'active' => true,
                ],
                'default'     => esc_html__('This is the heading 2', 'anila'),
                'placeholder' => esc_html__('Enter your heading 2', 'anila'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'anila'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'left',
                'options' => [
                    'left' => esc_html__( 'Before', 'anila' ),
                    'right' => esc_html__( 'After', 'anila' ),
                ],
        ...
        $this->add_control(
            'link_click',
            [
                'label'     => esc_html__('Apply Link On', 'anila'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'box'    => esc_html__('Whole Box', 'anila'),
                    'button' => esc_html__('Button Only', 'anila'),
                ],
                'default'   => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            'content-stretch',
            [
                'label'        => esc_html__('Stretch', 'anila'),
        ...
        $this->add_responsive_control(
            'Horizontal_align',
            [
                'label'     => esc_html__('Horizontal Align', 'anila'),
                ...
                'default'   => 'flex-start',
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-anila-banner.box-align-left .elementor-cta .elementor-cta__content' => 'justify-content: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'inner_padding',
            [
                'label'      => esc_html__('Padding Content', 'anila'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em'],
                'selectors'  => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Content', 'anila'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'      => '',
                'selectors'    => [
                    '{{WRAPPER}}.elementor-widget-anila-banner.box-align-center .elementor-cta .elementor-cta__content' => 'text-align: {{VALUE}}',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'label'     => esc_html__('Heading', 'anila'),
                'separator' => 'before',
                'condition' => [
                    'title!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Enable Effect', 'anila'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            [
                'type'      => Controls_Manager::HEADING,
                'label'     => esc_html__('Subtitle', 'anila'),
                'separator' => 'before',
                'condition' => [
                    'subtitle!' => '',
                ],
        ...
        $this->add_control(
            'title_color',
            [
                'label'     => esc_html__('Heading Color', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'heading2_color',
            [
                'label'     => esc_html__('Heading2 Color', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label'     => esc_html__('Sub title Color', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label'     => esc_html__('Description Color', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => 'default',
                'prefix_class' => 'button-banner-style-anila-',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Position Bottom', 'anila'),
                'type'         => Controls_Manager::SWITCHER,
                'condition'    => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}}.button-banner-style-anila-link .elementor-button::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}}.button-banner-style-anila-link .elementor-button:hover:after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Box Text Color', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => esc_html__('Hover Effects', 'anila'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'       => '{{WRAPPER}}.elementor-widget-anila-banner:not(:hover) .elementor-cta__bg-overlay',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}}.elementor-widget-anila-banner:hover .elementor-cta__bg',
            ]
        );
...
$widgets_manager->register(new Anila_Call_To_Action());
