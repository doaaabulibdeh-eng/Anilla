...
class Anila_Elementor_Account extends Elementor\Widget_Base {

    public function get_name() {
        return 'anila-accountsss';
    }

    public function get_title() {
        return esc_html__('Anila Account', 'anila');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'value'   => 'anila-icon- anila-icon-account',
                    'library' => 'anila',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Anila\Elementor\Anila_Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Content', 'anila'),
                'name'     => 'typography',
        ...
        $this->add_group_control(
            Anila\Elementor\Anila_Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Content Name', 'anila'),
        ...
        $this->add_control(
            'content_color',
            [
                'label'     => esc_html__('Color Content', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'name_text_color',
            [
                'label'     => esc_html__('Color Name', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Name Hover', 'anila'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .site-header-account a:hover .account-content .content-content'  => 'color: {{VALUE}};',
...
$widgets_manager->register(new Anila_Elementor_Account());
