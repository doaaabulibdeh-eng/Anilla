...
class Anila_Elementor_Countdown extends Elementor\Widget_Base {

    public function get_name() {
        return 'anila-countdown';
    }

    public function get_title() {
        return esc_html__('Anila Countdown', 'anila');
    }
    ...
    public function get_script_depends() {
        return ['anila-elementor-countdown'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_countdown',
            [
                'label' => esc_html__('Countdown', 'anila'),
            ]
        );
        ...
        $this->add_control(
            'due_date',
            [
                'label'       => esc_html__('Due Date', 'anila'),
                'type'        => Controls_Manager::DATE_TIME,
                'default'     => date('Y-m-d H:i', strtotime('+1 month') + (get_option('gmt_offset') * HOUR_IN_SECONDS)),
                /* translators: %s: Time zone. */
                'description' => sprintf(esc_html__('Date set according to your timezone: %s.', 'anila'), Utils::get_timezone_string()),
            ]
        );
        ...
        $this->add_control(
            'show_minutes',
            [
                'label'     => esc_html__('Minutes', 'anila'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'anila'),
                'label_off' => esc_html__('Hide', 'anila'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_seconds',
            [
                'label'     => esc_html__('Seconds', 'anila'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'anila'),
                'label_off' => esc_html__('Hide', 'anila'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_labels',
            [
                'label'     => esc_html__('Show Label', 'anila'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'anila'),
                'label_off' => esc_html__('Hide', 'anila'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'custom_labels',
            [
                'label'     => esc_html__('Custom Label', 'anila'),
                'type'      => Controls_Manager::SWITCHER,
                'condition' => [
                    'show_labels!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Days', 'anila'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Days', 'anila'),
                'placeholder' => esc_html__('Days', 'anila'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_days'      => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Hours', 'anila'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Hours', 'anila'),
                'placeholder' => esc_html__('Hours', 'anila'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_hours'     => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Minutes', 'anila'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Minutes', 'anila'),
                'placeholder' => esc_html__('Minutes', 'anila'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_minutes'   => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Seconds', 'anila'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Seconds', 'anila'),
                'placeholder' => esc_html__('Seconds', 'anila'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_seconds'   => 'yes',
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label'      => esc_html__('Container Width', 'anila'),
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .elementor-anila-countdown' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'items_width',
            [
                'label'      => esc_html__('Items Width', 'anila'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'items_height',
            [
                'label'      => esc_html__('Items Height', 'anila'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}}.elementor-widget-anila-countdown .elementor-countdown-item:before' => 'right: -{{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'   => 'center',
                'selectors' => [
                    '{{WRAPPER}} .elementor-anila-countdown' => 'justify-content: {{VALUE}}',
    ...
    private function _init_default_countdown_labels() {
        $this->_default_countdown_labels = [
            'label_months'  => esc_html__('Months', 'anila'),
            'label_weeks'   => esc_html__('Weeks', 'anila'),
            'label_days'    => esc_html__('Days', 'anila'),
            'label_hours'   => esc_html__('Hrs', 'anila'),
            'label_minutes' => esc_html__('Mins', 'anila'),
            'label_seconds' => esc_html__('Secs', 'anila'),
        ];
    }
    ...
    protected function render() {
        ...
        <div class="countdown-inner">
            ...
            <?php endif; ?>
            <div class="elementor-anila-countdown" data-date="<?php echo esc_attr($due_date); ?>">
                <?php echo anila_elementor_get_strftime($instance, $this); // WPCS: XSS ok. ?>
            </div>
        </div>
        <?php
    }
...
$widgets_manager->register(new Anila_Elementor_Countdown());
