...
class Anila_Elementor_Testimonials extends Anila_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Anila Testimonials', 'anila');
    }
    ...
    public function get_script_depends() {
        return ['anila-elementor-testimonial'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => esc_html__('Testimonials', 'anila'),
            ]
        );
        ...
        $repeater->add_control(
            'testimonial_rating',
            [
                'label'   => esc_html__('Rating', 'anila'),
                'default' => 5,
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    0 => esc_html__('Hidden', 'anila'),
                    1 => esc_html__('Very poor', 'anila'),
                    2 => esc_html__('Not that bad', 'anila'),
                    3 => esc_html__('Average', 'anila'),
                    4 => esc_html__('Good', 'anila'),
                    5 => esc_html__('Perfect', 'anila'),
                ]
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            'icon-view',
            [
                'label'        => esc_html__('Icon-view', 'anila'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'default' => esc_html__('Default', 'anila'),
                    'stacked' => esc_html__('Stacked', 'anila'),
                    'framed'  => esc_html__('Framed', 'anila'),
                ],
                'default'      => 'default',
        ...
        $this->add_control(
            ...
            [
                ...
                'prefix_class' => 'anila-testimonial-layout-',
            ]
        );
        ...
        $this->add_control(
            'show_gradient',
            [
                'label'        => esc_html__('Show Backgroup', 'anila'),
         ...
         $this->add_responsive_control(
            'spacing_x',
            [
                'label'      => esc_html__('Horizontal Left', 'anila'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'spacing_y',
            [
                'label'      => esc_html__('Horizontal Right', 'anila'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'background_hover',
            [
                'label'     => esc_html__('Background Hover', 'anila'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'   => [
                    ...
                    '{{WRAPPER}} .anila-testimonial-top-content .inner'  => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'align_caption',
            [
                'label'     => esc_html__('Alignment Info ', 'anila'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'flex-start' => [
                        'title' => esc_html__('Left', 'anila'),
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .anila-testimonial-top-content .swiper-slide'  => 'justify-content: {{VALUE}}',
        ...
        $this->add_control(
            'alignment_position',
            [
                'label'        => esc_html__('Alignment Position', 'anila'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .anila-testimonial-top-content .title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        [
            ...
            'selectors'      => [
                '{{WRAPPER}} .elementor-testimonial-item-wrapper .inner' => 'max-width: {{SIZE}}{{UNIT}};',
                '{{WRAPPER}} .anila-testimonial-top-content .inner' => 'max-width: {{SIZE}}{{UNIT}};',
            ],
        ]
    );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .anila-testimonial-top-content .name' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'         => Controls_Manager::SWITCHER,
                'prefix_class' => 'show-icon-position-',
                'separator'    => 'before',
            ]
        );
        ...
        if ($testimonial['testimonial_rating'] && $testimonial['testimonial_rating'] > 0) {
            ...
            for ($i = 1; $i <= 5; $i++) {
                if ($i <= $testimonial['testimonial_rating']) {
                    echo '<i class="anila-icon-star active" aria-hidden="true"></i>';
                }
            }
            echo '</div>';
        }
...
$widgets_manager->register(new Anila_Elementor_Testimonials());
