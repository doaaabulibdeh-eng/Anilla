...
class Anila_Elementor_Heading extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Anila Heading', 'anila');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Add Your Heading Text Here', 'anila'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Add Your Sub Title Text Here', 'anila'),
            ]
        );
        ...
        $this->add_control(
            'title-effect-heading',
            [
                'label'        => esc_html__('Title Effect', 'anila'),
                'type'         => Controls_Manager::SWITCHER,
                'prefix_class' => 'title-effect-heading-'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'small'   => esc_html__('Small', 'anila'),
                    'medium'  => esc_html__('Medium', 'anila'),
                    'large'   => esc_html__('Large', 'anila'),
                    'xl'      => esc_html__('XL', 'anila'),
                    'xxl'     => esc_html__('XXL', 'anila'),
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Text_Shadow::get_type(),
            [
                'label'    => __('Text shadow subtitle', 'anila'),
...
$widgets_manager->register(new Anila_Elementor_Heading());