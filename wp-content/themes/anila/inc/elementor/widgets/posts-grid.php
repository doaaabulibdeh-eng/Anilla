...
/**
 * Class Anila_Elementor_Blog
 */
class Anila_Elementor_Post_Grid extends Anila_Base_Widgets {

    public function get_name() {
        return 'anila-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'anila');
    }
    ...
    public function get_script_depends() {
        return ['anila-elementor-posts-grid'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'anila'),
                    'post_title' => esc_html__('Title', 'anila'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'post-style-1' => esc_html__('Style 1', 'anila'),
                    'post-style-2' => esc_html__('Style 2', 'anila'),
                ],
...
$widgets_manager->register(new Anila_Elementor_Post_Grid());