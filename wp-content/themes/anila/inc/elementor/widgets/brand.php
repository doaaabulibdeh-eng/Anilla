 ...
 * @since 1.0.0
 */
class Anila_Elementor_Brand extends Anila_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Brands', 'anila');
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'anila'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'anila'),
                'placeholder' => esc_html__('Brand Name', 'anila'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => '',
                'prefix_class' => 'anila-brand-border-'
            ]
        );
...
$widgets_manager->register(new Anila_Elementor_Brand());
