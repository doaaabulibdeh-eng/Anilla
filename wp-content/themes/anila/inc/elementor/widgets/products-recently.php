 ...
 * @since 1.0.0
 */
class Anila_Elementor_Widget_Products_Recently extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'anila-products-recently';
    }
    ...
    public function get_title() {
        return esc_html__('Products Recently', 'anila');
    }
    ...
    protected function render() {
        ...
        if (empty($viewed_products)) {
            echo '<p class="recently-notice">' . esc_html__('There’s no item that you viewed recently.', 'anila') . '</p>';
            return;
        }
...
$widgets_manager->register(new Anila_Elementor_Widget_Products_Recently());
